...
public class Wolf : MonoBehaviour, IPredator, IPrey
{
    ...
    {
        //Debug.Log("O lobo está caçando a presa!");
    ...
    private void procurarPresa()
    {
        ...
        {
            // Ignorar o próprio objeto que contém o script
